...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className="bg-white border border-gray-100 rounded-2xl p-4 flex flex-col gap-3 relative hover:shadow-lg transition-shadow duration-300 justify-between">
      ...
      {/* Action Button */}
      <button className="w-full mt-2 bg-[#2C6E91] text-white text-sm font-semibold py-3 rounded-xl hover:bg-[#235875] transition flex items-center justify-center gap-2">
        <span>+</span> Keranjang
      </button>
    </div>
  );
