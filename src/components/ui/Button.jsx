...
const Button = ({ 
  ...
  const baseStyles = `px-6 py-2.5 rounded-2xl text-white font-bold text-sm md:text-base md:px-8 md:py-3 transition-all duration-300 flex items-center justify-center text-center ${variants[variant]} ${className}`;
